...
Route::middleware(['auth'])->group(function(){
	...
	Route::get('roles/{store}', 'RoleController@edit')->name('roles.edit')
	->middleware('permission:roles.edit');
	...
	Route::get('products/{store}', 'ProductController@edit')->name('products.edit')
	->middleware('permission:products.edit');
	...
	Route::get('users/{store}', 'UsersController@edit')->name('users.edit')
	->middleware('permission:users.edit');
